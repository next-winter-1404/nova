      ...
      <form action={formAction}>
        <DashboardContentContainer>
          ...
          <div className="flex flex-col-center gap-10  w-full">
            <h1 className="text-center text-2xl text-white-pure">
            ...
            <LoginButton
              buttonText=" پیش بینی قیمت"
              noIcon
              width="w-[300px]"
              loadingText="پیش بینی قیمت..."
            />
          </div>
          <p className="text-white-pure flex gap-2 items-center mt-6">
