            ...
            <div className="flex flex-col gap-15 justify-center items-center h-full">
              <div className="flex justify-between w-full">
                <div className="flex-center gap-2">
                  ...
                  <p className="text-white md:text-[20px] text-[13px] whitespace-nowrap font-semibold">
                    در امد ماه جاری
                  </p>
                </div>
                <div
                  className="rounded-xl bg-primary-accent-green md:w-[219px] p-2"
                  dir="rtl"
                >
                  <div className="flex gap-2 w-full">
                    <p>
                      {formatPrice(
                        Number(SellerFinanceDashboard.totalCurrentMonthAmount),
                      )}
                    </p>
                    <span>تومان</span>
                  </div>
              ...
              <div className="flex justify-between w-full">
                ...
                <div
                  className="rounded-xl bg-gray-300 md:w-[219px] p-2"
                  dir="rtl"
                >
                  <div className="flex gap-2 w-full">
                    <p>
                      {formatPrice(Number(SellerFinanceDashboard.totalAmount))}
                    </p>
                    <span>تومان</span>
                  </div>
                </div>
          ...
          <div className="flex flex-col w-full  ">
            ...
            <div className="flex text-white mt-5 items-center">
              {booking?.length > 0 ? (
                ...
                <div className="text-3xl text-center w-full text-gray-300">
                  رزروی وجود ندارد
                </div>
              )}
            </div>
