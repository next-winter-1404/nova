...
const Traveler = () => {
  ...
  return (
    <div className='flex flex-col items-center w-full' dir='rtl'>
        <div className='w-[1465px] flex border items-center justify-center border-amber-50 h-[142px] bg-dark-700 rounded-3xl'>
          ...
          <div className ='w-[340px] h-[110px] flex flex-col items-center justify-center'>
            <div className='w-[335px] h-[83px] flex-col border items-end flex gap-4'>
              ...
              <Button text={"تغییر هتل"} icon={<Image src={greenhotel} alt='greenhotel'/>} width='w-[120px]' height='h-[36px]' border='border-1 border-black' borderRadius='12px' textStyle={{color: "#8CFF45", fontSize:"16px"}} buttonStyle={{border:"2px solid #8CFF45"}}/>
            </div>
          </div>
        </div>
    </div>
