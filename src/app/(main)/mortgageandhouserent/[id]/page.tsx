          ...
          <div className="flex-center justify gap-7">
            <div className="flex-col-center gap-6 mt-4 sm:mt-0">
              <div className="sm:hidden flex-col-center gap-3">
                ...
                <div className="sm:hidden flex-center gap-4 relative overflow-hidden rounded-xl">
                  <GlareHover
                  ...
                  <div className="w-[101px] h-[36px] flex-center gap-4">
                    {tags?.map((tag, index) => {
                      return (
                        <GlareHover
                          key={index}
                      ...
                      <div className="flex-col-center gap-4">
                        <div className="w-full flex-center justify-between">
                          <div className="flex-center gap-0.5 text-16-medium text-primary-accent-green">
                            ...
                            <span>
                              {formatPrice(
                                Number(getHouseInfo?.discounted_price),
                              )}
                            </span>
                          </div>
                        ...
                        <div className="w-full flex-center justify-between">
                          <div className="flex-center gap-0.5 text-16-medium text-primary-accent-green">
                            <span>ت</span>
                            <span>
                              {formatPrice(Number(getHouseInfo?.price))}
                            </span>
                          </div>
                          <div className="flex-center gap-2 text-16-medium text-gray-300">
                          ...
                          <div className="w-full flex-col-center gap-6">
                            {isLoggedIn ? (
                              <Chat
                                ...
                                sellerId={Number(getHouseInfo?.sellerId)}
                                sellerName={getHouseInfo?.sellerName}
                              />
                            ) : (
