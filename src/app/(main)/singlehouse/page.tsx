  ...
  return (
    <div className="padding-section flex-col-center sm:mt-24 mt-15 bg-tomato-red">
        <div className="flex-col-center sm:gap-6 gap-3">
            ...
            <div className="flex-center justify gap-5">
                <div className="flex flex-1">LeftOne</div>
                <div className="flex-col-center flex-1 rounded rounded-[32px]">
                    <div className="rounded rounded-[32px]"><Image src={HousePicture} alt="home pic"/></div>
                    <div className="relative rounded rounded-[32px] bg-dark-900-transparent-64">
                        <Image src={HousePicture} alt="home pic"/>
                        <span> +12 عکس دیگر </span>
                    </div>
                </div>
