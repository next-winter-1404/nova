...
export const verifyNumber = async (prevState: any, formData: FormData) => {
  const code = formData.get("NumberVerificationCode");
  ...
  try {
    ...
    const res = await instance.post("/api/auth/verify-phone", {
