  ...
  return (
    <>
      ...
      >
        ...
        {onClose && (
          <button
            className="absolute top-4 left-4 text-white-pure lg:hidden"
            onClick={onClose}
          >
        ...
        <div className="w-full justify-between items-center flex text-white-pure mt-8 lg:mt-0">
          <h1 className="text-[32px] font-extrabold text-white-pure">دلتا</h1>
          <LogoutButton />
        </div>

        <div className="w-full text-white-pure mt-10">
