...
import ShowPlaceByCoords from "../../common/map/ShowPlaceByCoords";
interface IProp {
  locationId: number;
  areaName: string;
  lat: string;
...
const LocationItemsManagement: FC<IProp> = ({
  locationId,
  areaName,
  lat,
  lng,
  ...
  const menuItems = [
    ...
    },
    {
      ...
      onClick: () =>
        router.push(`/dashboard/admin/locations/edit/${locationId}`),
    },
    {
      label: "حذف",
        ...
        mainContent={
          ...
          >
            ...
            <div className="w-full h-[300px] rounded-xl overflow-hidden">
              <ShowPlaceByCoords lat={Number(lat)} lng={Number(lng)} />
            </div>
          </div>
        }
