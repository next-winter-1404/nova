  ...
  return (
    <div className='flex'>
        <div className='flex flex-col justify-end flex-1 gap-4 whitespace-nowrap'>
            ...
            <Button text={"مشاهده ملک"} 
            backgroundColor='8cff45' icon={<Image src={leftArrow} alt='icon' />}
            buttonStyle={{background:"transparent",
                 width:'130px', color:"var(--color-primary-accent-green)", fontSize:"16px", fontWeight:"600",
                 border:"1px solid var(--color-primary-accent-green)", padding:"12px 16px"
        ...
        <div className='flex flex-2 gap-4'>
            ...
            <span className='flex justify-end text-20-medium whitespace-nowrap'>هتل سراوان رانین رشت</span>
            <div className='flex flex-col items-end gap-5'>
                <div className='flex justify-start gap-1.5'>
                <h2 className='text-[16px] text-gray-300 text-right  whitespace-nowrap'>آدرس : گیلان ، رشت ، میدان آزادی ، جل..</h2>
              ...
              <div className=' h-[16px] flex items-center justify-end text-gray-300 gap-1 whitespace-nowrap'>
                <div className=' w-[30px] text-[13px] justify-center flex gap-2.5'> حیاط <Image src={houseTree} alt='houseTree'/></div>                            
