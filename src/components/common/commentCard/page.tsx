  ...
  return (
    <>
      ...
      <CardContainer
        cavity="round"
        labelContent={
          <div className="w-[67px] h-[30px] mt-[5px] flex items-center  text-dark-800 justify-center gap-1 bg-white-pure rounded-[8px] ">
            <Image src={Star} alt="star" /> 4.5
          </div>
        }
        labelSize="lg"
        mainContent={
          <div className="md:w-[665px] w-[370px] md:h-[220px] h-[210px] flex flex-col items-center justify-center md:gap-6 gap-1 text-right">
              ...
              <div className="w-12/13 md:h-[57px] h-[50px] flex justify-end md:gap-4 gap-2">
                <div className="h-full md:w-[180px] md:gap-2.5 gap-1.5 flex flex-col justify-center text-[12px] md:text-[16px]">
                  ...
                  <h2 className="text-gray-300 flex gap-2">
                    12 مرداد - 1401 / 12:33{" "}
                    <Image src={calandar} alt="calandar" />
                  </h2>
                </div>
